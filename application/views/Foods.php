...
<section class="content">
    ...
    <?php
        if($action=='add'||$action=='edit'){
            ?>
            <form action="<?php echo base_url(); ?>Foods/save" class="form-validate1" method="post" enctype="multipart/form-data">
                <!-- Default box -->
                <div class="box box-default box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo ucfirst($action); ?> Foods</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            <span class="dropdown">
                            	<button type="button" class="dropdown-toggle btn btn-default" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button>
                            	<ul class="dropdown-menu dropdown-menu-right">
                            		<li><a href="<?php echo base_url(); ?>Foods" class="text-olive"><i class="fa fa-eye"></i> View Foods</a></li>
                            	</ul>
                            </span>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(file_exists($this->config->item('foods_dir').get_thumb($image,'135x100'))){
                                                    ?>
                                                    <div class="image_container">
                                                        <a class="fancybox" rel="gallery0" href="<?php echo $this->config->item('foods_url').$image; ?>">
                                                            <img src="<?php echo $this->config->item('foods_url').get_thumb($image,'135x100'); ?>" class="img-thumbnail" />
                                                        </a>
                                                        <a style="display: none;" href="<?php echo base_url(); ?>Foods/DeleteImage/<?php echo $slug; ?>/<?php echo $image; ?>" onclick="return false;" class="image_delete_link btn-delete-image" title="Delete Image"><i class="fa fa-remove"></i></a>
                                                    </div>
                                                    <?php
                                                }
                                                else{
                                                    ?>
                                                    <a class="fancybox" rel="gallery0" href="<?php echo $this->config->item('foods_url').NOIMAGEFOUND; ?>">
                                                        <img style="width: 150px; height: 150px;" src="<?php echo $this->config->item('foods_url').NOIMAGEFOUND; ?>" class="img-thumbnail" />
                                                    </a>
                                                    <?php
                                                }
                                            ?>
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <span class="dropdown">
                        	<button type="button" class="dropdown-toggle btn btn-default" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button>
                        	<ul class="dropdown-menu dropdown-menu-right">
                        		<li><a href="<?php echo current_url(); ?>/add"><i class="fa fa-plus"></i> Add Foods</a></li>
